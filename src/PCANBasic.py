...
#
from ctypes import (
    c_ushort, c_ubyte, c_ulonglong, c_char_p, c_uint, c_char, c_int64, c_int,
    Structure, byref, sizeof, create_string_buffer, windll, cdll
)
import platform
...
class PCANBasic:
    ...
    def FilterMessages(
        ...
        """
        if self.__m_dllBasic is None:
            raise Exception("PCANBasic DLL is not loaded. Cannot call CAN_FilterMessages.")
        try:
